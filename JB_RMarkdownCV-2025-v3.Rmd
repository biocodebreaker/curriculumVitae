...
My research interests include the study of Immune Cell Infiltration in the Tumor Microenvironment (TME) in Gastric Cancer, Cervical Cancer, and other cancers using bioinformatics tools. I am also interested in Multi-Omics studies to develop next-generation immunotherapies, Computational Modeling to develop novel prognostic models using AI/ML and T-cell-based immunotherapies (combination checkpoint blockade-CAR-T cell therapy). I am eager to learn and acquire new skills in Mass Spectrometry, Metabolomics and other techniques that I am not experienced with where necessary. 
...
=> Analyzed NGS data (Whole-Genome-Sequencing, Whole-Exome-Sequencing, TruSeq, RNA-Seq) for bone and soft tissue tumor studies. 
...
Experience with HPC clusters (UPPMAX, SNIC) and cloud computing (Amazon AWS, etc).
...
Our work inherently implements the FAIR Guiding Principles of Findability, Accessibility, Interoperability and Reusability which embrace the open-science and open-source principles of reproducibility and reusability. 
...
For a complete list of publications, please visit my: \textcolor{blue}{\href{https://scholar.google.com/citations?user=PZ6u9ocAAAAJ}{Google Scholar Profile}}.
